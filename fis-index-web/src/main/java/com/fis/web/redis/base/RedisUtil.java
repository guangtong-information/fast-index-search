...
public class RedisUtil<T> {
     ...
     * @return
     */
    public Set<Object> difference(String key, Collection<T> collections) {
     ...
     * @return 返回差集的数量
     */
    public Long differenceAndStore(String key, Collection<T> otherKeys, String newKey) {
     ...
     *
     * @param key
     * @param otherKeys key的集合
     * @return
     */
    public Set<Object> unionSet(String key, Collection<T> otherKeys) {
     ...
     * @return destKey 数量
     */
    public Long unionAndStoreSet(String key, Collection<T> otherKeys, String destKey) {
